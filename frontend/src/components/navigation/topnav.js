                ...
                <div className='items-container' >
                    <div className='movable-container' >
                        ...
                        {navLinks.map((item, id) => {
                            return (
                                selected === item ?
                                    <Link className={`selected`} onClick={handleClick} onMouseEnter={onMouseEnter} onMouseLeave={onMouseLeave} key={id} >
                                        {
                                    ...
                                    :
                                    <Link to={item.path} key={id} onClick={handleClick} onMouseEnter={onMouseEnter} onMouseLeave={onMouseLeave} >
                                        {item.label}
                                    </Link>
                            )
                        })}
                    ...
                    <Link to='/upload' onClick={handleClick} onMouseEnter={onMouseEnter} onMouseLeave={onMouseLeave} >
                        <Button
                            text='Upload'
                            type='button'
